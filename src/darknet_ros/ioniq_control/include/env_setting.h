...
// TSR
extern bool init_stop_search_flag;           // when stop signal at first.
extern double init_SP_distance;     // when init_SP_flag set to 1 distance of Stop Point is written
extern double init_target_speed;    // when init_SP_flag set to 1, Target Speed is written
extern double current_SP_distance;          // distance to Stop Point
extern bool SP_passing_flag;
extern bool vehicle_restart_flag;
