...
struct BoundingBox_
{
  ...
  _ymax_type ymax;
   ...
   typedef uint8_t _search_flag_type;
  _search_flag_type search_flag;
...
bool operator==(const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator1> & lhs, const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator2> & rhs)
{
  return lhs.Class == rhs.Class &&
    ...
    lhs.xmax == rhs.xmax &&
    lhs.ymax == rhs.ymax &&
    lhs.search_flag == rhs.search_flag;
}
...
struct MD5Sum< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >
{
  ...
  {
    return "a435ac16a0a3f3ecc63ab95979576843";
  }

  static const char* value(const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa435ac16a0a3f3ecULL;
  static const uint64_t static_value2 = 0xc63ab95979576843ULL;
};
...
struct Printer< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator>& v)
  {
    ...
    s << indent << "search_flag: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.search_flag);
  }
};
